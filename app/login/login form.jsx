...
export default function loginform(props) {
	...
	return (
		...
		<div className="p[w-380px] mx-auto bg-green-200">
			<div className="bg-white shadow-md border border-gray-200 rounded-lg p-4">
				<form onSubmit={handleSubmit} className="space-y-6">
					...
					<div className="flex items-start">
						<div className="flex items-start">
							<div className="flex items-center h-5 ">
								<input id="remember" type="checkbox" className="bg-gray-50 border  focus:ring-3 focus:ring-blue-300 h-4 w-4 rounded " />
							</div>
						...
						<a href="/forget password" className="text-sm text font-medium to-blue-700 hover:underline ml-auto">Lost Password?</a>
					</div>
					{/*submit button */}
					...
					<div className="flex justify-center text-sm font-medium text-gray-500 space-x-1">
						...
						<a href="/register" className="text-blue-700 hover:underline">Create an accoount</a>
					</div>
				</form>
			</div>
		</div>
